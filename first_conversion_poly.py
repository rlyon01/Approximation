...
remes_first_algorithm. The discrete grid is over the interval [21, 181] with
161 points. The polynomial order is 5.

The algorithm complete after 8 iterations and the maximum error is 9.770320e-01.

Module:
  first_conversion_poly

Usage:
  >>> from first_conversion_poly import main
  >>> main()
"""
...
def main() -> None:
  ...
  f = lambda x : calibrated(round(x))   # the conversion function
  lower = 21    # lower limit on interval of approximation
  upper = 181   # upper limit on interval of approximation
